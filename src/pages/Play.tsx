...
const Play = () => {
  ...
  useEffect(() => {
    if (game.turn() === 'b' && !game.isGameOver() && engineRef.current) {
      setEngineThinking(true);
      engineRef.current.setPosition(game.fen());
      engineRef.current.getBestMove((move) => {
        ...
        <div className="chess-board-section">
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar player-avatar-engine">
                <span>♞</span>
              </div>
              <div className="player-details">
                <span className="player-name">Stockfish</span>
                <span className="player-rating">
                  {engineThinking ? 'Thinking…' : 'Searching depth 12'}
                </span>
              </div>
            </div>
          ...
          <p className="engine-credit">
            ...
            by Niklas Fiekas — GPLv3. Not my work; I just wired up the board.
          </p>
        </div>
